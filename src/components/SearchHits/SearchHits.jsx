    ...
    <>
      ...
      >
        ...
        <div className="block md:hidden">
          <main className="max-w-7xl pt-content mx-auto px-4 py-6 md:ml-1/5 lg:px-8 ">
            <div className="flex sm:px-2 justify-between items-baseline ">
        ...
        <div className="hidden md:block">
          <main className=" pt-24 mx-auto ml-64 py-6 sm:px-6 lg:px-8">
            {/* <div className="sticky top-76 z-20 flex max-w-5xl mx-auto px-2 justify-between items-baseline"> */}
            <div className="top-76 z-20 flex  mx-auto px-2 justify-between">
