...
function ListItem({ url }) {
  return (
    <div class="flex max-w-5xl bg-white my-4 border-b border-gray-200 overflow-hidden rounded-lg shadow-md sm:shadow-xl mx-auto hover:cursor-pointer">
      ...
      <div className="flex space-y-1 mx-4 justify-between items-baseline w-full">
        <div className="font-semibold text-gray-900">Casa en las afueras de la ciudad</div>
